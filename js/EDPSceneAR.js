...
var EDPSceneAR = createReactClass({
  getInitialState() {
    return {
        ...
        <ViroARImageMarker
          ...
          <ViroNode scale={[0, 0, 0]} transformBehaviors={["billboardY"]}>
            <ViroVideo // primeiro esquerda, de cima para baixo
              ref={VIDEO_REF2}
              source={require('./res/vid/tesla.mp4')}
              volume={1.0}
              position={[-1.3, -6, -1.32]}
              scale={[1.4, 0.8, 0]}
              rotation={[-90, 0, 0]}
            ...
            <ViroVideo // primeiro direita, de cima para baixo
              ref={VIDEO_REF5}
              source={require('./res/vid/bulb.mp4')}
              volume={1.0}
              position={[1.2, -6, -2.6]}
              scale={[1.4, 0.8, 0]}
              rotation={[-90, 0, 0]}
            ...
            <ViroVideo // segundo esquerda, de cima para baixo
              ref={VIDEO_REF3}
              source={require('./res/vid/caixa.mp4')}
              volume={1.0}
              position={[-1.3, -6, 1]}
              scale={[1.4, 0.8, 0]}
              rotation={[-90, 0, 0]}
            ...
            <ViroVideo // segundo direita, de cima para baixo
              ref={VIDEO_REF4}
              source={require('./res/vid/packedp.mp4')}
              volume={1.0}
              position={[1.3, -6, -0.1]}
              scale={[1.4, 0.8, 0]}
              rotation={[-90, 0, 0]}
            ...
            <ViroVideo // terceiro esquerda, de cima para baixo
              ref={VIDEO_REF1}
              source={require('./res/vid/plasmaenergy.mp4')}
              volume={1.0}
              position={[-1.4, -6, 3.2]}
              scale={[1.4, 0.8, 0]}
              rotation={[-90, 0, 0]}
            ...
            <ViroVideo // terceiro direita, de cima para baixo
              ref={VIDEO_REF6}
              source={require('./res/vid/windturbine.mp4')}
              volume={1.0}
              position={[1.4, -6, 2.1]}
              scale={[1.4, 0.8, 0]}
              rotation={[-90, 0, 0]}
